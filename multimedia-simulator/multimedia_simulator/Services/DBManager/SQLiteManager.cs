    ...
    public class SQLiteManager: IDBManager, IDisposable
    {
        ...
        private string AllTables()
        {
            const string initScript = @"
                ...
                -- 2. טבלת קבצי מדיה (SourceFiles במקום Video-File)
                ...
                -- 3. טבלת ערוצים (Channels) עם שני Foreign Keys
                CREATE TABLE IF NOT EXISTS Channels (
                    ...
                    CONSTRAINT FK_Channels_SourceFiles FOREIGN KEY (SourceFilesId) 
                        REFERENCES SourceFiles(Id) ON DELETE RESTRICT
                );

                -- אינדקסים לשיפור מהירות שאילתות על Foreign Keys
